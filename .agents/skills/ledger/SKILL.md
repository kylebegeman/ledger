...
- Finished: you retitle it and fill it in, by editing the file or with `node dist/cli.js update <id> --title "<title>" --section "Summary=<text>"`, then `node dist/cli.js ready` gates it.
