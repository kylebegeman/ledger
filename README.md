...
```bash
npx --yes @kylebegeman/ledger@0.9.2 adopt
npx --yes @kylebegeman/ledger@0.9.2 hooks install --host claude-code \
  --command "npx --yes @kylebegeman/ledger@0.9.2" --import-agents
npx --yes @kylebegeman/ledger@0.9.2 skills install
npx --yes @kylebegeman/ledger@0.9.2 agents --write
```
...
`ledger`, `npm install --global @kylebegeman/ledger@0.9.2` and
  ...
  ledger:
    ...
    steps:
      - uses: actions/checkout@v6
        with:
          fetch-depth: 0
      - uses: kylebegeman/ledger@v0.9.2
        with:
          command: npx --yes @kylebegeman/ledger@0.9.2
```
